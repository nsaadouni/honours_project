...
\underline{\textbf{Chinese Remainder Theorem RSA cryptography}}\\

G.N.Shinde and H.S.Fadewar published a paper in 2008 [?] explaining how the use of the chienese remainder theorem can improve the efficiency of RSA encryptions and decryptions by upto a factor of four. It required three additional calculations which are the following:
\begin{enumerate}
