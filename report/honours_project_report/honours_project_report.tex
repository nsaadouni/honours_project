...
where K and C stand for something and something respectively.
...
here\\
explain how we wanted to ensure that for the same challenge the same response is calculated. (this was not possible up until this time as it had taken a while to get the man in the middle tool to operate correctly)

This is when we noticed the 4 characterstics that are within the appendix
