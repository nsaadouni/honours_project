...
we omitted the finding of the objects as that is the job of the findObject function.
Authentication occurs before the deletion of the objects as well.
...
** tried opening the key file responded with '69 81' $\rightarrow$ command incompatible with file structure **\\
commands 35, 36, 37 are present to show the key attribute file counter location, and its old value before it being updated.
\section{C\_encrypt}
