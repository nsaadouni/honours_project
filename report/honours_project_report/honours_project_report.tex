...
\item The second attack we research is the reverse engineering of the proprietary secure messaging protocol to encrypt APDU communication (specifically for our smartcard). This is a new area of research and has not been published in any literature regarding other hardware security modules.
\end{enumerate}

For 3 PKCS \#11 functions, our smartcard uses secure messaging at the APDU level to encrypt and append a checksum to the end of each command and response in a secure messaging session. 
