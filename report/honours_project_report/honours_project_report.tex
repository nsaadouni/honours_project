...
This is the characteristic that provides the evidence to support our theory that the 16 byte resposne is in-fact split into to 8 byte sections.



\textbf{\underline{Search 5 - DES2-ECB}}\\
\textbf{\underline{Search 6 - DES2-CBC}}\\
