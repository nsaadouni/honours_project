...
Each of the types of objects hold values in the following attribute fields to store the sensitive information the hold.
...
The objects shown within table 2.1 also have the following attributes that define controls the API should provide.
