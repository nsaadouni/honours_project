...
\item Create Private CTR RSA Key file (B.5 - command 64) [see section 2.2.1, chapter 2]
...
Components 1, 3, 5, 7, 9, 11, and 13 transfer data that are wrapped within an ASN.1 BER encoding \cite{kaliski1993layman}. We have used an online tool [?] to decode the data fields. The following are the ASN.1 BER decodings of the commands that have these wrapping. 
