...
All of the traces are provided in appendix B, which will be referred to in brackets with the corresponding command number for ease of locating the steps analysed.
