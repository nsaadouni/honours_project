...
The main sections we are interested in are 4, 7, 8, and 9. We have extracted out of the ISO/IEC 7816 standard the information we utilise within this project and reported it within sections boom, boom and boom.
...
\hline
\textbf{4}  & Organization, security and commands for interchange \\
\hline
5 & Registration of application providers \\
\hline
6 & Interindustry data elements for interchange \\
\hline
\textbf{7} response & Interindustry commands for Structured Card Query Language (SCQL) \\
\hline
\textbf{8} & Commands for security operations \\
\hline
\textbf{9} & Commands for card management \\
\hline
...
\hline
\textbf{13} defines control bytes for SM pbk & Commands for application management in multi-application environment \\
\hline
