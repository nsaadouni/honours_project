...
def create_private_AES_key(_id, _label, _value):
    print_header('Created private sensitive unextractable AES secret key "' + _label + '"')
    template = (
        (CKA_CLASS, CKO_SECRET_KEY),
        (CKA_KEY_TYPE, CKK_AES),
        (CKA_VALUE, _value),
...
print_header('login with pin "12345"...')
pin = '12345'
...
#generate_private_AES_key(4, 'Hades')

create_private_AES_key(5, 'Chaos', [_ for _ in range(1, 33)])
